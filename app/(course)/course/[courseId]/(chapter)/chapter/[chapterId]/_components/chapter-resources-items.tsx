...
interface ChapterResourcesItemsProps {
  resource: string;
  index: number;
}

export default function ChapterResourcesItems({
  resource,
  index,
}: ChapterResourcesItemsProps) {
  return (
    <div className="w-full">
      ...
      <div className="text-sm font-medium ">
        <div
          ...
          className="  text-left bg-white text-gray-800  border-gray-200 hover:border-gray-300 hover:shadow-md hover:bg-slate-200/80 transition-all duration-200 ease-in-out gap-x-6 border-radius-2xl pr-2 py-1 rounded-full border w-full mt-2"
        >
          <div className="flex gap-x-1 justify-between items-center w-full m-2">
            ...
            <div className="mr-4 cursor-pointer" >
              <Download size={20} className="text-blue-400" onClick={()=>alert("hey there")} />
            </div>
          </div>
        </div>
      </div>

...
const CourseAction=({courseId,isCompleted,isPublished,isAllchpaterOfcourseIsPublished}:CourseActionProps)=>{
    ...
    return(
        <div>
            <div className="flex items-center gap-x-2">
                ...
                <Button variant="outline" size="sm" onClick={onPublish} disabled={!isReadyToPublish}>

...
interface ChapterProps{
 ...
 const CharpterAction=({courseId,chapterId,disabled,isPublished,isCompleted}:ChapterProps)=>{
    ...
    return(
        <div className="flex items-center gap-x-2">
          ...
          <>
                ...
                <Button variant="outline"  onClick={PublishChapter} disabled={!isCompleted}>

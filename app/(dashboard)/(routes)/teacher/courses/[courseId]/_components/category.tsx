...
export const CategoryForm = ({initialeData,courseId,options}:CategoryFormProps) => {
    ...
    const selectedOption=options.find((option)=>option.value===initialeData.categoryId)
